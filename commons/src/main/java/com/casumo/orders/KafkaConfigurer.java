...
public class KafkaConfigurer {
    ...
    public KafkaProducer<String, String> commandProducer() {
        ...
        properties.put("value.deserializer", "com.casumo.orders.events.control.EventSerializer");
        ...
        properties.put("value.serializer", "com.casumo.orders.events.control.EventSerializer");
